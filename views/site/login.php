...
<?php if (!app()->auth::check()): ?>
   <form method="post" class="flex flex-col items-center max-w-xs border-2 border-zinc-800 rounded-xl mx-auto mt-5 p-5 gap-2.5">
       ...
       <button class="bg-zinc-800 w-40 h-10 text-white text-xl font-bold">Войти</button>
   </form>
<?php endif;