...
<h3><?= $message ?? ''; ?></h3>
<form method="post" class="flex flex-col max-w-xs border-2 border-zinc-800 rounded-xl mx-auto mt-5 p-5 gap-2.5">
   ...
   <button class="bg-zinc-800 w-60 h-10 text-white text-xl font-bold mx-auto">Зарегистрироваться</button>
</form>